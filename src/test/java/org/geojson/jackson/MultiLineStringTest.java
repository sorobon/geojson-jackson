...
import org.geojson.MultiLineStringFactory;
...
public class MultiLineStringTest {
	...
	public void itShouldSerialize() throws Exception {
		MultiLineString multiLineString = MultiLineStringFactory.create(
				Arrays.asList(create(100, 0), create(101, 1)),
				Arrays.asList(create(102, 2), create(103, 3)));
